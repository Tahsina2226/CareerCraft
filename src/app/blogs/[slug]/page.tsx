...
export default function BlogPage() {
      ...
      <div className="flex justify-center items-center bg-gradient-to-br from-[#B8C4A9] to-[#A8B497] min-h-screen">
        <div className="mx-auto p-8 max-w-md text-center">
          <div className="flex justify-center items-center bg-white/80 shadow-lg mx-auto mb-6 border border-[#B1AB86]/30 rounded-full w-32 h-32">
            <svg
              className="w-16 h-16 text-[#5D6D4B]/60"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <h1 className="bg-clip-text bg-gradient-to-r from-[#5D6D4B] to-[#7D8566] mb-4 font-bold text-[#5D6D4B] text-transparent text-3xl">
            Article Not Found
          </h1>
          <p className="mb-8 text-[#7D8566] text-lg">
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#B8C4A9] to-[#A8B497] min-h-screen overflow-hidden">
      ...
      <div
        className="right-0 bottom-0 fixed bg-[#B1AB86] opacity-5 rounded-full w-96 h-96 translate-x-1/2 translate-y-1/2 animate-float"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="top-1/3 left-1/4 fixed bg-[#7D8566] opacity-3 rounded-full w-48 h-48 animate-float"
        style={{ animationDelay: "4s" }}
      ></div>
      <div
        className="right-1/3 bottom-1/4 fixed bg-[#B1AB86] opacity-4 rounded-full w-32 h-32 animate-float"
            ...
            <div className="top-1/2 right-full absolute bg-white/95 shadow-2xl backdrop-blur-sm mr-4 p-4 border border-[#B1AB86]/30 rounded-2xl min-w-48 -translate-y-1/2 transform">
              <div className="flex flex-col space-y-3">
                <button
                  ...
                  className="flex items-center space-x-3 hover:bg-[#5D6D4B]/10 p-3 rounded-xl transition-all duration-200"
                >
          ...
          {blog.coverUrl && (
            <div className="relative h-80 md:h-96 overflow-hidden">
              <Image
                ...
                alt={blog.title}
                fill
                className="object-cover hover:scale-105 transition-transform duration-700 transform"
              />
            ...
            <div className="flex justify-center items-center mb-12">
              <div className="flex items-center space-x-6 bg-gradient-to-r from-[#5D6D4B]/5 to-[#B1AB86]/5 shadow-lg hover:shadow-xl px-8 py-6 border border-[#5D6D4B]/20 rounded-2xl hover:scale-105 transition-all duration-300 transform">
                ...
                <div className="sm:text-left text-center">
                  <p className="font-bold text-[#5D6D4B] text-lg">
                    👤 {blog.author.name}
                  </p>
                  <p className="mt-1 text-[#7D8566] text-sm">
                    ✉️ {blog.author.email}
                  </p>
