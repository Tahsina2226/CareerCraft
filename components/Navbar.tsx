...
export default function Navbar(): JSX.Element {
  ...
  const navItems = [
    ...
    { href: "/about", label: "About Me", icon: HiUserCircle },
  ...
  return (
    <nav className="top-0 right-0 left-0 z-50 fixed bg-white/95 shadow-2xl backdrop-blur-xl border-[#B1AB86]/20 border-b">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="-right-20 -bottom-20 absolute bg-[#5D6D4B] opacity-5 rounded-full w-40 h-40 animate-float"
        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            <div className="relative">
              <div
                className={`absolute inset-0 bg-[#B1AB86] opacity-20 rounded-full transition-all duration-500 ${
            ...
            <HiSparkles
              className={`w-4 h-4 text-[#B1AB86] transition-all duration-500 transform ${
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-r from-[#B1AB86] to-[#5D6D4B] opacity-0 group-hover:opacity-5 transition-opacity duration-300 ${
                      isActive ? "opacity-10" : ""
                    }`}
                  ></div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-4 bg-gradient-to-r from-[#B1AB86]/10 to-[#5D6D4B]/5 px-4 py-3 border border-[#B1AB86]/20 rounded-2xl">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-[#5D6D4B] text-sm">
                        {user?.name || "User"}
                      </p>
