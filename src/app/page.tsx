...
export default function HomePage() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#B8C4A9] via-[#A8B497] to-[#9CA885] pt-24 pb-16 min-h-screen overflow-hidden transition-colors duration-500">
      <div
      ...
      <div className="z-10 relative mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <section id="home" className="mb-24 text-center">
          ...
          >
            ...
            <div className="group relative bg-gradient-to-br from-white/95 to-white/90 shadow-2xl hover:shadow-3xl backdrop-blur-xl px-10 py-10 border-[#B1AB86]/40 border-2 rounded-3xl hover:scale-[1.02] transition-all duration-500">
              ...
              <div className="flex flex-col items-center gap-10">
                <div className="flex-1 text-center">
                  <div className="mb-6">
                    <h1 className="bg-clip-text bg-gradient-to-r from-[#5D6D4B] via-[#6B7A55] to-[#7D8566] mb-3 font-bold text-transparent text-5xl lg:text-6xl leading-tight hover:scale-105 transition-transform duration-300">
                      {personalInfo.name}
                    </h1>
                    <div className="inline-block relative">
                      <p className="mb-4 font-light text-[#7D8566] text-xl lg:text-2xl">
                        {personalInfo.title}
                      </p>
                  ...
                  <div className="relative bg-gradient-to-r from-[#F8F7F0] to-[#F0EEE0] mb-8 p-6 border border-[#B1AB86]/30 rounded-2xl">
                    ...
                    <p className="font-medium text-[#5D6D4B] text-lg leading-relaxed">
                      {personalInfo.shortBio}
                    </p>
                  </div>

                  <div className="gap-4 grid grid-cols-1 md:grid-cols-3 mb-8">
                    <div className="group flex justify-center items-center gap-3 bg-white/80 hover:shadow-lg backdrop-blur-sm px-5 py-3 border-[#B1AB86]/30 border-2 rounded-2xl hover:scale-105 transition-all duration-300">
                      <HiMap className="w-5 h-5 text-[#5D6D4B] group-hover:scale-110 transition-transform duration-300" />
                      <span className="font-medium text-[#7D8566]">
                        {personalInfo.location}
                      </span>
                    </div>
                    <div className="group flex justify-center items-center gap-3 bg-white/80 hover:shadow-lg backdrop-blur-sm px-5 py-3 border-[#B1AB86]/30 border-2 rounded-2xl hover:scale-105 transition-all duration-300">
                      <HiMail className="w-5 h-5 text-[#5D6D4B] group-hover:scale-110 transition-transform duration-300" />
                      <span className="font-medium text-[#7D8566]">
                        {personalInfo.email}
                      </span>
                    </div>
                    <div className="group flex justify-center items-center gap-3 bg-white/80 hover:shadow-lg backdrop-blur-sm px-5 py-3 border-[#B1AB86]/30 border-2 rounded-2xl hover:scale-105 transition-all duration-300">
                      <HiPhone className="w-5 h-5 text-[#5D6D4B] group-hover:scale-110 transition-transform duration-300" />
                      <span className="font-medium text-[#7D8566]">
                        {personalInfo.phone}
                      </span>
                    </div>
                  ...
                  <div className="flex flex-wrap justify-center gap-3">
                    {quickSkills.map((skill, index) => (
                      <span
                        key={index}
                        className="group relative bg-gradient-to-r from-[#5D6D4B]/10 hover:from-[#5D6D4B]/20 to-[#B1AB86]/10 hover:to-[#B1AB86]/20 hover:shadow-lg px-4 py-2 border border-[#B1AB86]/40 rounded-full font-semibold text-[#5D6D4B] text-sm hover:scale-105 transition-all duration-300 cursor-default transform"
                      >
                        {skill}
          ...
          >
            ...
            <Link
              href="/about"
              className="group relative flex items-center gap-4 bg-white/90 hover:bg-white shadow-xl hover:shadow-2xl px-10 py-5 border-[#B1AB86]/40 border-2 rounded-2xl font-bold text-[#5D6D4B] hover:scale-105 transition-all duration-300"
            >
            ...
            <button
              ...
              className="group relative flex items-center gap-4 bg-gradient-to-r from-[#B1AB86] hover:from-[#9C966F] to-[#C8C2A5] hover:to-[#B1AB86] shadow-xl hover:shadow-2xl px-10 py-5 rounded-2xl font-bold text-[#5D6D4B] hover:scale-105 transition-all duration-300"
            >
          ...
          <div className="mt-16 animate-bounce">
            <div className="inline-flex relative flex-col items-center gap-2">
              <span className="font-semibold text-[#5D6D4B] text-sm">
                Explore More
              </span>
              <HiChevronDown className="w-7 h-7 text-[#5D6D4B]" />
            </div>
          </div>
        </section>
